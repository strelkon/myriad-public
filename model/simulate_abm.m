...
if ~strcmp(scenario, 'S0')
    ...
    if isfield(shock, 'gamma_X_gr')
        for i=1:I
            gamma_X_i(:,i) = shock.gamma_X_gr(:,F_i(i),G_i(i));
        end
    end
